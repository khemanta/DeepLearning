...
%\newwatermark[pages=2-3,color=red!10,angle=45,scale=4.5,xpos=0,ypos=0]{Deep Learning}
%\newwatermark[allpages,color=red!10,angle=45,scale=4.5,xpos=0,ypos=0]{Deep Learning}
...
~~~ \\
\vspace{21cm}
{\color{blue} \small $\copyright$ Artifical Intelligence, Neural Networks and Deep Learning} --
