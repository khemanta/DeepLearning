...
%%---- Fontspec Config --------------
\usepackage{fontspec}
%\setmainfont{LucidaBright}  %{Garamond, Times New Roman, TeX Gyre Pagella}
...
\usepackage{imakeidx}
 \makeindex[columns=2, title={\Large \bf \color{IAF} Alphabetical Index}]
...
\newwatermark[pages=2-3,color=red!10,angle=0,scale=2.75,xpos=0,ypos=0]{Deep Learning}
\newwatermark[pages=4-,color=red!10,angle=45,scale=2.75,xpos=0,ypos=0]{Deep Learning}
%\newwatermark[allpages,color=red!10,angle=45,scale=3.25,xpos=0,ypos=0]{\sc deep learning}
...
%    \psbarcode{Artificial Intelligence - Neural Networks and Deep Learning - A Primer}{}{qrcode}
%  \end{pspicture}
...
% Customizing Chapter Name
\usepackage{fancyhdr}
\renewcommand{\chaptername}{\sc chapter}
%%-----------------------------------
\usepackage{graphicx}
\usepackage{sidecap}

%for the neural networks diagram below
\usepackage{tikz}
...
\author{%
% Kumar Hemant \\
%% \EANisbn[SC5b,ISBN=978-80-7340-097-2]
%foo
\fbox{%
\begin{pspicture}(0,-5pt)(2.25in,1in)
\psbarcode{K15022818H}{includetext width=2.25 height=1}{code39}
\end{pspicture}}
%bar
% {\sc DMC R\&D Center} \\
% {\sc Seoul R\&D Campus} \\
...
%%{Seoul RnD Campus,  SAMSUNG ELECTRONICS, khemanta@outlook.com}\\
}
...
\coordinate (aux1) at ([yshift=-35pt]current page.north east);  %-35pt
\coordinate (aux2) at ([yshift=-410pt]current page.north east); %-410pt
\coordinate (aux3) at ([xshift=-4.5cm]current page.north east); %-4.5cm
\coordinate (aux4) at ([yshift=-150pt]current page.north east); %-150pt
...
\begin{minipage}{0.30\linewidth}
   \rule{1pt}{80pt} %\hspace{1cm} {\tiny \EANisbn[SC5b,ISBN=978-80-7340-097-2]}
   %\begin{flushleft}
    \begin{pspicture}(.50in,.50in)
        \psbarcode{ Neural Networks and Deep Learning - A Primer on Artificial Intelligence by Kumar Hemant}{}{qrcode}
    \end{pspicture}
   %\end{flushleft}
%%foo
%\fbox{%
...
~~~ \\
\vspace{19cm}
{\color{blue} \small $\copyright$ Artificial Intelligence, Neural Networks, and Deep Learning} --
...
\section{Perceptrons}
What is a neural network? To get started, I'll explain a type of artificial neuron called a perceptron. Perceptrons\index{perceptron} were developed in the 1950s and 1960s by the scientist Frank Rosenblatt, inspired by earlier work by Warren McCulloch and Walter Pitts. Today, it's more common to use other models of artificial neurons - in this book, and in much modern work on neural networks, the main neuron model used is one called the sigmoid neuron. We'll get to sigmoid neurons shortly. But to understand why sigmoid neurons are defined the way they are, it's worth taking the time to first understand perceptrons.
...
Recurrent neural nets have been less influential than feedforward networks, in part because the learning algorithms for recurrent nets are (at least to date) less powerful. But recurrent networks are still extremely interesting. They're much closer in spirit to how our brains work than feedforward networks. And it's possible that recurrent networks can solve important problems which can only be solved with great difficulty by feedforward networks. However, to limit our scope, in this book we're going to concentrate on the more widely-used feedforward\index{feedforward} networks.
...
To recognize individual digits we will use a three-layer neural network\index{neural network}:
...
The second layer of the network is a hidden layer. We denote the number of neurons in this hidden layer by $n$, and we'll experiment with different values for $n$. The example shown illustrates a small hidden layer, containing just $n=15$ neurons\index{neurons}.
...
\begin{equation}
 %\begin{bmatrix} f(2) & f(3) \\ yz & yw \end{bmatrix} = f (\left[ \begin{array}{c} 2 \\ 3 \end{array} \right] ) \times \left[ \begin{array}{cc} z & w \end{array} \right]
...
\begin{center}
 \includegraphics[width=0.60\linewidth]{images/tikz18.png}
\end{center}
...
\begin{equation}
 % \big[ 1 \\ 2 \big ] \odot \big[ 3 \\ 4 \big] = \big[1∗3 \\ 2∗4 \big] = \big[ 3 \\ 8 \big]
...
\begin{center}
 \includegraphics[width=0.80\linewidth]{images/tikz19.png}
\end{center}
...
\begin{center}
 \includegraphics[width=0.60\linewidth]{./images/extraneous/TreeDef.png}
\end{center}
...
\begin{center}
 \includegraphics[width=0.60\linewidth]{./images/TreeEval.png}
\end{center}
...
\begin{enumerate}%{thebibliography}{9}
...
%\makeindex
%{\LARGE \bf \color{IAF} Alphabetical Index}
